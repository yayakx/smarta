<nav x-data="{ open: false }" class="bg-primary border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto col-md-10 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{asset('img/logo-unesa.png')}}" class="block h-10 w-auto fill-current text-white" />                        
                    </a>
                    <h3 class="ms-2 text-light"><b>SMART-A</b></h3>
                </div>
