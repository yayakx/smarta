...
@section('content')
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Halaman Data Berkas</li>
        </ol>
        <div class="row">
            <div class="col-xl-4">
                <div class="card mb-4">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="row">
                    ...
                    <a class="ms-auto btn btn-sm btn-success col-md-2" href="#" data-bs-toggle="modal"
                        data-bs-target="#tambahBerkas"><i class="fa fa-plus"></i> Tambahkan Berkas</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @foreach ($berkas as $item)
                            <tr>
                                ...
                                <td>@if($item->is_verified)<div class="badge bg-success">Terverifikasi</div>@else<div class="badge bg-danger">Belum diverifikasi</div>@endif</td>
                                ...
                                <td>
                                    <div class="row ms-0 col-md-12">
                                        ...
                                        <a href="#" onclick="confirmDelete('/hapus-berkas/{{$item->id}}')" class="btn btn-sm btn-danger col-md"><i class="fa fa-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @php
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('tambah-berkas') }}">
                        ...
                        <input type="text" class="form-control" value=""
                            name="judul" placeholder="Judul Berkas">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('edit-berkas') }}">
                        ...
                        <label for="nama">Judul</label>
                        <input type="text" class="form-control" value=""
                            name="judul" placeholder="Judul Berkas" id="judul">

                        <label for="nama">Link Berkas</label>
                        <input type="text" class="form-control" value=""
                            name="link" placeholder="https://" id="link">
